...
import CheckoutForm from "../checkout/CheckoutForm"; // Import the CheckoutForm component


const AddProducts = ({ items, click, removeItem, setAddedItem }) => {
  const [showCheckout, setShowCheckout] = useState(false); // State to control showing the checkout form
  const total = items
    .reduce((pre, cur) => {
      ...
      <div className="right-side">
        ...
        <div className="right-side-footer">
          ...
          <div className="check-out">
            {/* Conditionally render CheckoutForm or the Check Out button */}
            {showCheckout ? (
              <CheckoutForm />
            ) : (
              <button
